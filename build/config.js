...
exports.config = {
    CORS_ORIGIN: process.env.NODE_ENV === "production" ? 'to be deployed' : 'http://localhost:3001',
    ...
    MYSQL_DATABASE_URL: process.env.NODE_ENV === "production"
        ? "mysql://trailbliz:trailbliz@prod-host:3306/prod-db"
        : "mysql://trailbliz:trailbliz@localhost/trailbliz",
    // redis not currently in use
    REDIS_URL: process.env.NODE_ENV === "production" ? process.env.REDIS_URL_PROD : process.env.REDIS_URL_DEV,
    GOOGLE_CLIENT_ID: process.env.GOOGLE_CLIENT_ID,
    GOOGLE_CLIENT_SECRET: process.env.GOOGLE_CLIENT_SECRET,
    JWT_EXPIRES_IN: process.env.JWT_EXPIRES_IN || "10d",
    JWT_COOKIE_EXPIRES_IN: parseInt((_a = process.env.JWT_COOKIE_EXPIRES_IN) !== null && _a !== void 0 ? _a : "864000000") || 864000000,
