...
export const addDayContent = async (req: Request, res: Response) => {
  ...
  try {
    ...
    // Get the last day number to determine the new day number
    ...
    res
      .status(500)
      .json({ message: "Internal server error while adding day content" });
  }
};
...
export const getDayContent = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Internal server error while fetching day content" });
  }
};
...
export const updateDayContent = async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (content !== undefined) {
      dayContent.content = sanitizeContent(content); // Sanitize the updated content
    ...
    res
      .status(500)
      .json({ message: "Internal server error while updating day content" });
  }
};
...
export const deleteDayContent = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Internal server error while deleting day content" });
  }
};
...
export const markDayAsCompleted = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({
        message: "Internal server error while marking day as completed",
      });
  }
};
